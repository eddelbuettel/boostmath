...
#'
#' Computes the Legendre polynomial of the first kind \(P_n(x)\).
#'
...
#'
#' Computes the derivative of the Legendre polynomial of the first kind \(P_n'(x)\).
#'
#' @param n Degree of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the derivative of the Legendre polynomial \(P_n'(x)\).
#' @export
...
#'
#' Computes the zeros of the Legendre polynomial of the first kind \(P_l(x)\).
#'
#' @param l Degree of the polynomial
#' @return A numeric vector containing the zeros of the Legendre polynomial \(P_l(x)\).
#' @export
...
#'
#' Computes the Legendre polynomial of the first kind \(P_n^m(x)\).
#'
#' @param n Degree of the polynomial
#' @param m Order of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the Legendre polynomial \(P_n^m(x)\).
#' @export
...
#'
#' Computes the Legendre polynomial of the second kind \(Q_n(x)\).
#'
#' @param n Degree of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the Legendre polynomial \(Q_n(x)\).
#' @export
...
#'
#' Computes the next Legendre polynomial of the first kind \(P_{l+1}(x)\) using the previous two polynomials.
#'
#' @param l Degree of the polynomial
#' @param x Argument of the polynomial
#' @param Pl Value of the Legendre polynomial \(P_l(x)\)
#' @param Plm1 Value of the Legendre polynomial \(P_{l-1}(x)\)
#' @return The value of the next Legendre polynomial \(P_{l+1}(x)\).
#' @export
...
#'
#' Computes the next Legendre polynomial of the first kind \(P_{l+1}^m(x)\) using the previous two polynomials.
#'
#' @param l Degree of the polynomial
#' @param m Order of the polynomial
#' @param x Argument of the polynomial
#' @param Pl Value of the Legendre polynomial \(P_l^m(x)\)
#' @param Plm1 Value of the Legendre polynomial \(P_{l-1}^m(x)\)
#' @return The value of the next Legendre polynomial \(P_{l+1}^m(x)\).
#' @export
...
#' @param n Degree of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the Laguerre polynomial \(L_n(x)\).
#' @export
...
#'
#' Computes the Laguerre polynomial \(L_n^m(x)\).
#'
#' @param n Degree of the polynomial
#' @param m Order of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the Laguerre polynomial \(L_n^m(x)\).
#' @export
...
#'
#' Computes the next Laguerre polynomial \(L_{n+1}(x)\) using the previous two polynomials.
#'
#' @param n Degree of the polynomial
#' @param x Argument of the polynomial
#' @param Ln Value of the Laguerre polynomial \(L_n(x)\)
#' @param Lnm1 Value of the Laguerre polynomial \(L_{n-1}(x)\)
#' @return The value of the next Laguerre polynomial \(L_{n+1}(x)\).
#' @export
...
#'
#' Computes the next Laguerre polynomial \(L_{n+1}^m(x)\) using the previous two polynomials.
#'
#' @param n Degree of the polynomial
#' @param m Order of the polynomial
#' @param x Argument of the polynomial
#' @param Ln Value of the Laguerre polynomial \(L_n^m(x)\)
#' @param Lnm1 Value of the Laguerre polynomial \(L_{n-1}^m(x)\)
#' @return The value of the next Laguerre polynomial \(L_{n+1}^m(x)\).
#' @export
...
#' @param n Degree of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the Hermite polynomial \(H_n(x)\).
#' @export
...
#'
#' Computes the next Hermite polynomial \(H_{n+1}(x)\) using the previous two polynomials.
#'
#' @param n Degree of the polynomial
#' @param x Argument of the polynomial
#' @param Hn Value of the Hermite polynomial \(H_n(x)\)
#' @param Hnm1 Value of the Hermite polynomial \(H_{n-1}(x)\)
#' @return The value of the next Hermite polynomial \(H_{n+1}(x)\).
#' @export
...
#'
#' Computes the next Chebyshev polynomial of the first kind \(T_{n+1}(x)\) using the previous two polynomials.
#'
#' @param x Argument of the polynomial
#' @param Tn Value of the Chebyshev polynomial \(T_n(x)\)
#' @param Tn_1 Value of the Chebyshev polynomial \(T_{n-1}(x)\)
#' @return The value of the next Chebyshev polynomial \(T_{n+1}(x)\).
#' @export
...
#'
#' Computes the derivative of the Chebyshev polynomial of the first kind \(T_n'(x)\).
#'
#' @param n Degree of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the derivative of the Chebyshev polynomial \(T_n'(x)\).
#' @export
...
#'
#' Computes the next Chebyshev polynomial of the first kind \(T_{n+1}(x)\) using Clenshaw's recurrence relation.
#'
...
#' Chebyshev Polynomial of the First Kind using Clenshaw's Recurrence with Interval [a, b]
#'
#' Computes the Chebyshev polynomial of the first kind \(T_n(x)\) using Clenshaw's recurrence relation with a specified interval \([a, b]\).
#'
#' @param c Coefficients of the Chebyshev polynomial
#' @param a Lower bound of the interval
#' @param b Upper bound of the interval
#' @param x Argument of the polynomial
#' @return The value of the Chebyshev polynomial \(T_n(x)\) evaluated at \(x\) in the interval \([a, b]\).
#' @export
...
#'
#' Computes the real part of the spherical harmonic function \(Y_{n}^{m}(\theta, \phi)\).
#'
...
#' @return The real part of the spherical harmonic function \(Y_{n}^{m}(\theta, \phi)\).
#' @export
...
#'
#' Computes the imaginary part of the spherical harmonic function \(Y_{n}^{m}(\theta, \phi)\).
#'
#' @param n Degree of the spherical harmonic
#' @param m Order of the spherical harmonic
#' @param theta Polar angle (colatitude)
#' @param phi Azimuthal angle (longitude)
#' @return The imaginary part of the spherical harmonic function \(Y_{n}^{m}(\theta, \phi)\).
#' @export
...
#'
#' Computes the Gegenbauer polynomial \(C_n^{(\lambda)}(x)\).
#'
#' @param n Degree of the polynomial
#' @param lambda Parameter of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the Gegenbauer polynomial \(C_n^{(\lambda)}(x)\).
#' @export
...
#'
#' Computes the derivative of the Gegenbauer polynomial \(C_n^{(\lambda)}(x)\).
#'
#' @param n Degree of the polynomial
#' @param lambda Parameter of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the derivative of the Gegenbauer polynomial \(C_n^{(\lambda)}(x)\).
#' @export
...
#'
#' Computes the k-th derivative of the Gegenbauer polynomial \(C_n^{(\lambda)}(x)\).
#'
#' @param n Degree of the polynomial
#' @param lambda Parameter of the polynomial
#' @param x Argument of the polynomial
#' @param k Order of the derivative
#' @return The value of the k-th derivative of the Gegenbauer polynomial \(C_n^{(\lambda)}(x)\).
#' @export
...
#' Jacobi Polynomial
#'
#' Computes the Jacobi polynomial \(P_n^{(\alpha, \beta)}(x)\).
#'
#' @param n Degree of the polynomial
#' @param alpha First parameter of the polynomial
#' @param beta Second parameter of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the Jacobi polynomial \(P_n^{(\alpha, \beta)}(x)\).
#' @export
...
#'
#' Computes the derivative of the Jacobi polynomial \(P_n^{(\alpha, \beta)}(x)\).
#'
#' @param n Degree of the polynomial
#' @param alpha First parameter of the polynomial
#' @param beta Second parameter of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the derivative of the Jacobi polynomial \(P_n^{(\alpha, \beta)}(x)\).
#' @export
...
#'
#' Computes the second derivative of the Jacobi polynomial \(P_n^{(\alpha, \beta)}(x)\).
#'
#' @param n Degree of the polynomial
#' @param alpha First parameter of the polynomial
#' @param beta Second parameter of the polynomial
#' @param x Argument of the polynomial
#' @return The value of the second derivative of the Jacobi polynomial \(P_n^{(\alpha, \beta)}(x)\).
#' @export
...
#'
#' Computes the k-th derivative of the Jacobi polynomial \(P_n^{(\alpha, \beta)}(x)\).
#'
#' @param n Degree of the polynomial
#' @param alpha First parameter of the polynomial
#' @param beta Second parameter of the polynomial
#' @param x Argument of the polynomial
#' @param k Order of the derivative
#' @return The value of the k-th derivative of the Jacobi polynomial \(P_n^{(\alpha, \beta)}(x)\).
#' @export
