...
The [Quadrature and Differentiation](https://www.boost.org/doc/libs/latest/libs/math/doc/html/quadrature.html) section of the Boost Math library provides methods for numerical integration and differentiation of functions. These methods can be used directly in R without needing any additional compilation.
