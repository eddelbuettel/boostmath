...
extern "C" {
  SEXP gamma_pdf_(SEXP x_, SEXP shape_, SEXP scale_) {
    ...
    double result = boost::math::pdf(boost::math::gamma_distribution<>(shape, scale), x);
  ...
  SEXP gamma_lpdf_(SEXP x_, SEXP shape_, SEXP scale_) {
    ...
    double shape = cpp11::as_cpp<double>(shape_);
    double scale = cpp11::as_cpp<double>(scale_);
    double result = boost::math::logpdf(boost::math::gamma_distribution<>(shape, scale), x);
    return cpp11::as_sexp(result);
    END_CPP11
  }
  ...
  SEXP gamma_cdf_(SEXP x_, SEXP shape_, SEXP scale_) {
    ...
    double shape = cpp11::as_cpp<double>(shape_);
    double scale = cpp11::as_cpp<double>(scale_);
    double result = boost::math::cdf(boost::math::gamma_distribution<>(shape, scale), x);
    return cpp11::as_sexp(result);
    END_CPP11
  }
  ...
  SEXP gamma_lcdf_(SEXP x_, SEXP shape_, SEXP scale_) {
    ...
    double shape = cpp11::as_cpp<double>(shape_);
    double scale = cpp11::as_cpp<double>(scale_);
    double result = boost::math::logcdf(boost::math::gamma_distribution<>(shape, scale), x);
    return cpp11::as_sexp(result);
    END_CPP11
  }
  ...
  SEXP gamma_quantile_(SEXP p_, SEXP shape_, SEXP scale_) {
    ...
    double shape = cpp11::as_cpp<double>(shape_);
    double scale = cpp11::as_cpp<double>(scale_);
    double result = boost::math::quantile(boost::math::gamma_distribution<>(shape, scale), p);
    return cpp11::as_sexp(result);
    END_CPP11
  }
}
